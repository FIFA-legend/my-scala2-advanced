...
object TypeClasses extends App {
  ...
  // 1 - we can define serializers for the other types
  ...
  // access to the entire class type interface
  ...
  println(john.toHTML) // println(new HTMLEnrichment[User](john).toHTML(UserSerializer2))
  // COOL!
  /*
    - extend to new types
